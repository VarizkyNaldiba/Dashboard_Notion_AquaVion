  ...
  return (
    <div className="overflow-x-auto w-full pb-10">
      <table className="w-full text-left text-sm whitespace-nowrap">
        <thead>
          <tr className="border-b border-[var(--notion-border)] text-[var(--notion-text-gray)]">
        ...
        <tbody>
          {tasks.map((task) => (
            <tr
              key={task.id}
              className="border-b border-[var(--notion-border)] hover:bg-[var(--notion-hover)] transition-colors group"
            >
              <td className="py-2.5 px-3 text-[var(--notion-text-gray)]">{task.wbsCode}</td>
              ...
              <td className="py-2.5 px-3 text-[var(--notion-text-gray)]">{task.phase}</td>
              <td className="py-2.5 px-3">
                <span className="text-[var(--notion-text-gray)] border border-[var(--notion-border)] rounded px-1.5 py-0.5 text-xs bg-[var(--notion-bg)]">
                  {task.level}
                </span>
              </td>
            </tr>
          ...
          {/* New Row Placeholder */}
          <tr className="hover:bg-[var(--notion-hover)] transition-colors cursor-pointer text-[var(--notion-text-gray)]">
